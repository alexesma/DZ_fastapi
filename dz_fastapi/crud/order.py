...
class CRUDOrder(CRUDBase[Order, OrderIn, OrderUpdate]):
    async def create_order_with_items(
        ...
        for item in items:
            order_item = OrderItem(
                ...
                external_supplier_id=item.supplier_id,
                external_supplier_name=item.supplier_name,
                external_price_name=item.price_name,
                external_sup_logo=item.sup_logo,
