...
ERROR_MESSAGE_RANGE_DATE = (
    '{key} не может быть меньше ' '1980 и больше текущей даты'
)
...
INDICATOR_LIFAN_FIRST_THREE_2 = ['S10']
...
INDICATOR_CHANGAN_END_THREE = ['M06']
INDICATOR_CHANGAN_FIRST_TWO = ['K0']
...
INDICATOR_HAIMA_FULL = ['HC0020660BM1', 'SA0034156M1', 'B25D67482AL1']
...
INDICATOR_LIFAN_LEN_TEN = ['BBF', 'SCA']
INDICATOR_LIFAN_LEN_SEVEN = ['SA2', 'SB3', 'SF3', 'SS2']
CUMMINS_OEM = ['5255313']
...
INDICATOR_LIFAN_END_FIVE = ['T13F6', '00TF3', 'T13F3']
INDICATOR_LIFAN_END_FOUR = ['TF30', '0TF3']
INDICATOR_FOTON = ['E049343000008', '1106911800005', 'T2666108B', 'P700000181']
INDICATOR_GEELY_FIRST_TWO = ['LP']
GEELY_NOT_OEM = [
    '4408640001',
]
...
INDICATOR_LIFAN_WHISOUT = ['6007RSNR', '6006ERSN', 'HK301600']
INDICATOR_END_IS_NOT_LIFAN = ['S', 'E']
INDICATOR_LIFAN_WHISOUT_FIRST = ['0']
...
INDICATOR_FAW_OTHER_PATTERNS = ['27060', '52576', '85310', '67861', '90080']
FAW_OEM = [
    '1105110M01A00',
    '19130T2A20',
    '2911052HL',
...
BRILLIANCE_OEM = ['3437007', '3483012', 'DAMD194294', 'SHZ2200026']
...
def create_supplier_params(
    ...
    return {
        ...
        'title_line': (
            title_line if title_line is not None else default_title_line
        ),
        'start_line': (
            start_line if start_line is not None else default_start_line
        ),
...
SUPPLIER_PARAM = {
    '1c': create_supplier_params(
        'xlsx', '1c_invoice.xlsx', 'Sheet1', 0, 0, [0, 1, 2, 3, 4]
    ),
    'reline': create_supplier_params(
        'csv', 'relines.csv', None, 0, 17, [1, 5, 9, 26, 57]
    ),
    'autotorg': create_supplier_params(
        'xls', 'партс.xls', 'TDSheet', 13, 17, [1, 5, 9, 26, 57]
    ),
    'apex': create_supplier_params(
        'xls', 'apex.xls', 'TDSheet', 20, 0, [3, 20, 5, 33, 49]
    ),
    'hot-parts': create_supplier_params(
        'xls', '71977.xls', 'Report', 27, 0, [0, 1, 22, 58]
    ),
    'redline': create_supplier_params(
        'xls', 'redline.xls', 'TDSheet', 18, 0, [1, 9, 13, 35, 64]
    ),
    'techo': create_supplier_params(
        'xls', 'nk2023111600027.xls', 'Лист1', 20, 0, [1, 5, 6, 10, 18]
    ),
    'froza': create_supplier_params(
        'xls', 'froza.xls', 'TDSheet', 18, 0, [1, 9, 13, 35, 67, 88]
    ),
    'autopiter': create_supplier_params(
        'xls', 'piter.xls', 'TDSheet', 24, 0, [1, 5, 9, 26, 57]
    ),
}
...
SPANISH_BRAND = ['AJUSA', 'DOLZ', 'FAE', 'FRENKIT']
SOUTH_KOREA = [
    'ASIN',
    'AVANTECH',
    'CTR',
...
TAIWAN = ['DEPO', 'NAKAMOTO', 'RBI', 'SH', 'TENACITY']
POLAND = ['FA1', 'NTY']
RUSSIA = ['GAZPROMNEFT', 'MOSKVICH', 'ROSTECO']
ITALY = ['METELLI']
