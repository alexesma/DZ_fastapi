...
price_list_autopart_association = Table(
    ...
    Base.metadata,
    Column('pricelist_id', Integer, ForeignKey('pricelist.id')),
    Column('autopart_id', Integer, ForeignKey('autopart.id')),
...
customer_price_list_autopart_association = Table(
    ...
    Base.metadata,
    Column('customerpricelist_id', Integer, ForeignKey('customerpricelist.id')),
    Column('autopart_id', Integer, ForeignKey('autopart.id')),
    Column('quantity', Integer, nullable=False),
    Column('price', DECIMAL(10, 2)),
