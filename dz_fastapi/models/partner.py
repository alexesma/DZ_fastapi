...
from sqlalchemy import DECIMAL, JSON, BigInteger, Boolean, Column, Date, DateTime
from sqlalchemy import Enum as SAEnum
from sqlalchemy import Float, ForeignKey, Index, Integer, String, Text, UniqueConstraint, event
...
class SupplierResponseConfig(Base):
    ...
    file_payload_type = Column(String(16), default="response", nullable=False)
    ...
    brand_priority_list = Column(JSON, default=list)
    brand_from_name_regex = Column(String(255), nullable=True)
    ...
    document_number_cell = Column(String(16), nullable=True)
    document_date_cell = Column(String(16), nullable=True)
    document_meta_cell = Column(String(16), nullable=True)
...
class CustomerExternalReference(Base):
    customer_id = Column(
        Integer,
    ...
    external_customer_name = Column(String(255), nullable=True)
    external_classification = Column(JSON, default=dict, nullable=False)
    ...
    customer = relationship("Customer", back_populates="external_references")
